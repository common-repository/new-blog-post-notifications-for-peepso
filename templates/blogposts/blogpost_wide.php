<div class="ps-blogposts-container ps-blogposts-container-wide">
	<div class="ps-blogposts-container-inside ps-blogposts-container-wide-inside">

		<?php if('top' == $image_position) echo $image;?>

		<div class="ps-blogposts-main ps-blogposts-wide-main">
